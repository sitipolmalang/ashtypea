...
config :ashtypea, AshtypeaWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: AshtypeaWeb.ErrorHTML, json: AshtypeaWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Ashtypea.PubSub,
  live_view: [signing_salt: "EHv48MAZ"]
...
config :ashtypea, Ashtypea.Mailer, adapter: Swoosh.Adapters.Local
